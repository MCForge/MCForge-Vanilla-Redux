...
namespace MCForge.Commands
{
    public class CmdOpStats : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            DataTable reviewcount = SQLite.fillData("SELECT COUNT(ID) FROM Opstats WHERE Time >= '" + timespan + "' AND Time < '" + timespanend + "' AND Name LIKE '" + message + "' AND Cmd LIKE 'review' AND Cmdmsg LIKE 'next'");
